...
TRACE_DIR = PROJECT_ROOT / "fixtures/traces/live-sanitized"
LIVE_FIXTURES = ("icon-search", "color-swatch", "svg-dashboard")


def main() -> None:
    TRACE_DIR.mkdir(parents=True, exist_ok=True)
    with TemporaryDirectory(prefix="voice-browser-live-") as runtime_dir:
        ...
        for fixture_id in LIVE_FIXTURES:
            ...
            trace.execution_id = f"live-{fixture_id}"
